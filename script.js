...
function calcularSueldo() {
    ...
    document.getElementById('result').innerHTML = `
        <h2>Detalle del Sueldo  Mes: Diciembre 2025 Paritaria Anterior</h2>
        <p>Nombre: ${nombre}</p>
        <table>
